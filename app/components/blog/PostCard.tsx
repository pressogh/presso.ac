...
const PostCard = ({ post }: Props) => {
	return (
		<Link href={`/blog/${post.title.replace(/ /g, "-")}`}>
			<div className={`transform duration-300 hover:pl-4 hover:border hover:border-t-0 hover:border-r-0 hover:border-b-0 hover:border-l-4 hover:border-indigo-950 dark:hover:border-indigo-800`}>
