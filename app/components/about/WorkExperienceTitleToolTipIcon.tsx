...
const WorkExperienceTitleToolTipIcon = ({ type }: { type: LinkType }) => {
	if (type === 'github') {
		return (
			<svg fill="white" viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg" aria-hidden="true" className={`w-8 h-8`}>
				<path
					fillRule="evenodd"
		...
		return (
			<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 511.999 511.999" className={`w-8 h-8 ml-0.5`}>
				<g>
		...
		return (
			<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 600 600" className={`w-8 h-8 ml-0.5 scale-[2.0]`}>
				<g>
					<g>
		...
		return (
			<svg viewBox="0 0 38 57" xmlns="http://www.w3.org/2000/svg" aria-hidden="true" className={`w-8 h-8 ml-0.5`}>
		...
		return (
			<svg fill="none" stroke="currentColor" strokeWidth={2} viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" aria-hidden="true" className={`w-8 h-8`}>
...
export default WorkExperienceTitleToolTipIcon;
